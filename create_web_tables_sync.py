#!/usr/bin/env python3
"""
Создание таблиц для веб-аутентификации в Neon PostgreSQL (синхронная версия)
"""
