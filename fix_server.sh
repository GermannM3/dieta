...
echo "🧹 Полная очистка сервера и исправление..."

echo "1️⃣ Остановка всех контейнеров..."
docker-compose -f docker-compose.minimal.yml down 2>/dev/null
docker-compose down 2>/dev/null

echo "2️⃣ Очистка локальных изменений..."
git reset --hard HEAD
git clean -fd

echo "3️⃣ Удаление конфликтующих файлов/папок..."
rm -rf nginx-ssl-working.conf
rm -f quick_fix.sh

echo "4️⃣ Подтягивание изменений..."
git pull

echo "5️⃣ Создание правильного nginx конфига..."
